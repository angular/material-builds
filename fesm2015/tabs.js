...
class MatPaginatedTabHeader {
    ...
    _updateTabScrollPosition() {
        ...
        // @breaking-change 9.0.0-sha-fd1593df1 Remove null check for `platform` after it can no longer be undefined.
...
if (false) {
    ...
    /**
     * @deprecated \@breaking-change 9.0.0-sha-fd1593df1 `_platform` and `_animationMode`
