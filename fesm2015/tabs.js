...
class MatPaginatedTabHeader {
    ...
    _updateTabScrollPosition() {
        ...
        // @breaking-change 9.0.0-sha-42ff0ae10 Remove null check for `platform` after it can no longer be undefined.
...
if (false) {
    ...
    /**
     * @deprecated \@breaking-change 9.0.0-sha-42ff0ae10 `_platform` and `_animationMode`
