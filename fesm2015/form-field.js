...
import { Input, Directive, InjectionToken, ViewChild, ElementRef, ContentChild, ContentChildren, QueryList, Component, ViewEncapsulation, ChangeDetectionStrategy, Optional, Inject, ChangeDetectorRef, NgZone, NgModule } from '@angular/core';
...
let MatFormFieldControl = /** @class */ (() => {
    let MatFormFieldControl = class MatFormFieldControl {
    };
...
let MatPlaceholder = /** @class */ (() => {
    let MatPlaceholder = class MatPlaceholder {
    };
