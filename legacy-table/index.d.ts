...
export declare class MatLegacyCell extends CdkCell {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<MatLegacyCell, "mat-cell, td[mat-cell]", never, {}, {}, never, never, false, never, false>;
}
...
export declare class MatLegacyCellDef extends CdkCellDef {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<MatLegacyCellDef, "[matCellDef]", never, {}, {}, never, never, false, never, false>;
}
...
export declare class MatLegacyColumnDef extends CdkColumnDef {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<MatLegacyColumnDef, "[matColumnDef]", never, { "sticky": { "alias": "sticky"; "required": false; }; "name": { "alias": "matColumnDef"; "required": false; }; }, {}, never, never, false, never, false>;
}
...
export declare class MatLegacyFooterCell extends CdkFooterCell {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<MatLegacyFooterCell, "mat-footer-cell, td[mat-footer-cell]", never, {}, {}, never, never, false, never, false>;
}
...
export declare class MatLegacyFooterCellDef extends CdkFooterCellDef {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<MatLegacyFooterCellDef, "[matFooterCellDef]", never, {}, {}, never, never, false, never, false>;
}
...
export declare class MatLegacyFooterRow extends CdkFooterRow {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<MatLegacyFooterRow, "mat-footer-row, tr[mat-footer-row]", ["matFooterRow"], {}, {}, never, never, false, never, false>;
}
...
export declare class MatLegacyFooterRowDef extends CdkFooterRowDef {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<MatLegacyFooterRowDef, "[matFooterRowDef]", never, { "columns": { "alias": "matFooterRowDef"; "required": false; }; "sticky": { "alias": "matFooterRowDefSticky"; "required": false; }; }, {}, never, never, false, never, false>;
}
...
export declare class MatLegacyHeaderCell extends CdkHeaderCell {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<MatLegacyHeaderCell, "mat-header-cell, th[mat-header-cell]", never, {}, {}, never, never, false, never, false>;
}
...
export declare class MatLegacyHeaderCellDef extends CdkHeaderCellDef {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<MatLegacyHeaderCellDef, "[matHeaderCellDef]", never, {}, {}, never, never, false, never, false>;
}
...
export declare class MatLegacyHeaderRow extends CdkHeaderRow {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<MatLegacyHeaderRow, "mat-header-row, tr[mat-header-row]", ["matHeaderRow"], {}, {}, never, never, false, never, false>;
}
...
export declare class MatLegacyHeaderRowDef extends CdkHeaderRowDef {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<MatLegacyHeaderRowDef, "[matHeaderRowDef]", never, { "columns": { "alias": "matHeaderRowDef"; "required": false; }; "sticky": { "alias": "matHeaderRowDefSticky"; "required": false; }; }, {}, never, never, false, never, false>;
}
...
export declare class MatLegacyNoDataRow extends CdkNoDataRow {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<MatLegacyNoDataRow, "ng-template[matNoDataRow]", never, {}, {}, never, never, false, never, false>;
}
...
export declare class MatLegacyRecycleRows {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<MatLegacyRecycleRows, "mat-table[recycleRows], table[mat-table][recycleRows]", never, {}, {}, never, never, false, never, false>;
}
...
export declare class MatLegacyRow extends CdkRow {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<MatLegacyRow, "mat-row, tr[mat-row]", ["matRow"], {}, {}, never, never, false, never, false>;
}
...
export declare class MatLegacyRowDef<T> extends CdkRowDef<T> {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<MatLegacyRowDef<any>, "[matRowDef]", never, { "columns": { "alias": "matRowDefColumns"; "required": false; }; "when": { "alias": "matRowDefWhen"; "required": false; }; }, {}, never, never, false, never, false>;
}
...
export declare class MatLegacyTable<T> extends CdkTable<T> {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<MatLegacyTable<any>, "mat-table, table[mat-table]", ["matTable"], {}, {}, never, ["caption", "colgroup, col"], false, never, false>;
}
...
export declare class MatLegacyTextColumn<T> extends CdkTextColumn<T> {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<MatLegacyTextColumn<any>, "mat-text-column", never, {}, {}, never, never, false, never, false>;
}
