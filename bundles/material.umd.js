...
MdTabNav.decorators = [
    { type: _angular_core.Component, args: [{ selector: '[md-tab-nav-bar], [mat-tab-nav-bar], [mdTabNav], [matTabNav]',
...
var CdkTable = (function () {
    ...
    function CdkTable(_differs, _changeDetectorRef, elementRef, renderer, role) {
         ...
         */
        this._columnsChange = new rxjs_Observable.Observable();
        /**
    ...
    CdkTable.prototype.ngAfterContentInit = function () {
        ...
        this._columnsChange = rxjs_Observable.Observable.merge.apply(rxjs_Observable.Observable, columnChangeStreams);
    };
    /**
     * @return {?}
     */
    CdkTable.prototype.ngAfterViewInit = function () {
        ...
        rxjs_Observable.Observable.combineLatest(streams).subscribe(function (_a) {
            var rowsData = _a[0];
