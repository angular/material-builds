...
/**
     ...
     */var m=new i.InjectionToken("mat-checkbox-default-options",{providedIn:"root",factory:h});function h(){return{color:"accent",clickAction:"check-indeterminate"}}var d,k=new i.InjectionToken("mat-checkbox-click-action"),l=0,b={provide:c.NG_VALUE_ACCESSOR,useExisting:i.forwardRef((function(){return p})),multi:!0};
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
e.MAT_CHECKBOX_CLICK_ACTION=k,e.MAT_CHECKBOX_CONTROL_VALUE_ACCESSOR=b,e.MAT_CHECKBOX_DEFAULT_OPTIONS=m,e.MAT_CHECKBOX_DEFAULT_OPTIONS_FACTORY=h,e.MAT_CHECKBOX_REQUIRED_VALIDATOR=f,e.MatCheckbox=p,e.MatCheckboxChange=u,e.MatCheckboxModule=_,e.MatCheckboxRequiredValidator=g,e._MatCheckboxRequiredValidatorModule=y,Object.defineProperty(e,"__esModule",{value:!0})}));