...
/**
     ...
     */var h=new i.InjectionToken("mat-checkbox-default-options",{providedIn:"root",factory:d});function d(){return{color:"accent",clickAction:"check-indeterminate"}}var k,l=new i.InjectionToken("mat-checkbox-click-action"),u=0,b={provide:c.NG_VALUE_ACCESSOR,useExisting:i.forwardRef(function(){return x}),multi:!0};
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
e.MAT_CHECKBOX_CONTROL_VALUE_ACCESSOR=b,e.MatCheckboxChange=p,e.MatCheckbox=x,e.MAT_CHECKBOX_DEFAULT_OPTIONS=h,e.MAT_CHECKBOX_DEFAULT_OPTIONS_FACTORY=d,e.MAT_CHECKBOX_CLICK_ACTION=l,e._MatCheckboxRequiredValidatorModule=_,e.MatCheckboxModule=C,e.MAT_CHECKBOX_REQUIRED_VALIDATOR=g,e.MatCheckboxRequiredValidator=y,Object.defineProperty(e,"__esModule",{value:!0})});