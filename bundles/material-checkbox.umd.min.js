...
/**
     ...
     */var h=new c.InjectionToken("mat-checkbox-default-options",{providedIn:"root",factory:d});function d(){return{color:"accent",clickAction:"check-indeterminate"}}var k,l=new c.InjectionToken("mat-checkbox-click-action"),b=0,u={provide:i.NG_VALUE_ACCESSOR,useExisting:c.forwardRef((function(){return x})),multi:!0};
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
e.MAT_CHECKBOX_CLICK_ACTION=l,e.MAT_CHECKBOX_CONTROL_VALUE_ACCESSOR=u,e.MAT_CHECKBOX_DEFAULT_OPTIONS=h,e.MAT_CHECKBOX_DEFAULT_OPTIONS_FACTORY=d,e.MAT_CHECKBOX_REQUIRED_VALIDATOR=f,e.MatCheckbox=x,e.MatCheckboxChange=p,e.MatCheckboxModule=C,e.MatCheckboxRequiredValidator=y,e._MatCheckboxRequiredValidatorModule=_,Object.defineProperty(e,"__esModule",{value:!0})}));