    ...
    ***************************************************************************** */
    ...
    var _MatTabGroupBase = /** @class */ (function (_super) {
        ...
        _MatTabGroupBase.prototype._subscribeToTabLabels = function () {
            ...
            this._tabLabelSubscription = rxjs.merge.apply(void 0, __spreadArray([], __read(this._tabs.map(function (tab) { return tab._stateChanges; })), false)).subscribe(function () { return _this._changeDetectorRef.markForCheck(); });
        };
