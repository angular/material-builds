...
/**
     ...
     */var u=function(t){function e(){return null!==t&&t.apply(this,arguments)||this}return s.__extends(e,t),e.decorators=[{type:r.Directive,args:[{selector:"[matStepLabel]"}]}],e}(n.CdkStepLabel),g=function(){function t(){this.changes=new d.Subject,this.optionalLabel="Optional"}return t.decorators=[{type:r.Injectable,args:[{providedIn:"root"}]}],t.ngInjectableDef=r.ɵɵdefineInjectable({factory:function e(){return new t},token:t,providedIn:"root"}),t}();
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
