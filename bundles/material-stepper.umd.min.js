...
/**
     ...
     */var u=function(t){function e(){return null!==t&&t.apply(this,arguments)||this}return l.__extends(e,t),e.decorators=[{type:r.Directive,args:[{selector:"[matStepLabel]"}]}],e}(n.CdkStepLabel),g=function(){function t(){this.changes=new d.Subject,this.optionalLabel="Optional"}return t.decorators=[{type:r.Injectable,args:[{providedIn:"root"}]}],t.ngInjectableDef=r.ɵɵdefineInjectable({factory:function e(){return new t},token:t,providedIn:"root"}),t}();
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
t.MatStepperModule=C,t.MatStepLabel=u,t.MatStep=_,t.MatStepper=S,t.MatHorizontalStepper=z,t.MatVerticalStepper=I,t.MatStepperNext=w,t.MatStepperPrevious=M,t.MatStepHeader=x,t.MatStepperIntl=g,t.MAT_STEPPER_INTL_PROVIDER_FACTORY=b,t.MAT_STEPPER_INTL_PROVIDER=f,t.matStepperAnimations=v,t.MatStepperIcon=y,Object.defineProperty(t,"__esModule",{value:!0})});