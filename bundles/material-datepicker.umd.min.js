...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
e.MAT_DATEPICKER_SCROLL_STRATEGY=P,e.MAT_DATEPICKER_SCROLL_STRATEGY_FACTORY=Y,e.MAT_DATEPICKER_SCROLL_STRATEGY_FACTORY_PROVIDER=T,e.MAT_DATEPICKER_VALIDATORS=B,e.MAT_DATEPICKER_VALUE_ACCESSOR=L,e.MatCalendar=R,e.MatCalendarBody=A,e.MatCalendarCell=b,e.MatCalendarHeader=M,e.MatDatepicker=j,e.MatDatepickerContent=F,e.MatDatepickerInput=z,e.MatDatepickerInputEvent=W,e.MatDatepickerIntl=v,e.MatDatepickerModule=K,e.MatDatepickerToggle=U,e.MatDatepickerToggleIcon=q,e.MatMonthView=C,e.MatMultiYearView=w,e.MatYearView=I,e.matDatepickerAnimations=E,e.yearsPerPage=k,e.yearsPerRow=4,Object.defineProperty(e,"__esModule",{value:!0})}));