...
/**
     ...
     */var d,h,g=new e.Version("10.2.3-sha-ce49e2f2c");
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
var Y=function(){function t(){}return t.prototype.isErrorState=function(t,e){return!!(t&&t.invalid&&(t.dirty||e&&e.submitted))},t}();Y.decorators=[{type:e.Injectable}];var U,z=function(){function t(){}return t.prototype.isErrorState=function(t,e){return!!(t&&t.invalid&&(t.touched||e&&e.submitted))},t}();function B(t,e,n){void 0===n&&(n="mat"),t.changes.pipe(l.startWith(t)).subscribe((function(t){var i=t.length;W(e,n+"-2-line",!1),W(e,n+"-3-line",!1),W(e,n+"-multi-line",!1),2===i||3===i?W(e,n+"-"+i+"-line",!0):i>3&&W(e,n+"-multi-line",!0)}))}function W(t,e,n){var i=t.nativeElement.classList;n?i.add(e):i.remove(e)}z.ɵprov=e.ɵɵdefineInjectable({factory:function t(){return new z},token:z,providedIn:"root"}),z.decorators=[{type:e.Injectable,args:[{providedIn:"root"}]}],(U=function U(){}).decorators=[{type:e.Directive,args:[{selector:"[mat-line], [matLine]",host:{class:"mat-line"}}]}];var Z,q=function q(t,e){B(t,e)};(Z=function Z(){}).decorators=[{type:e.NgModule,args:[{imports:[_],exports:[U,_],declarations:[U]}]}];
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
