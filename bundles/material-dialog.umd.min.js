...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */var S=function(){function t(){}return t.decorators=[{type:i.NgModule,args:[{imports:[a.CommonModule,e.OverlayModule,o.PortalModule,n.MatCommonModule],exports:[m,k,T,x,E,n.MatCommonModule],declarations:[m,k,T,E,x],providers:[A,O],entryComponents:[m]}]}],t}();
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */t.MAT_DIALOG_DATA=v,t.MAT_DIALOG_DEFAULT_OPTIONS=b,t.MAT_DIALOG_SCROLL_STRATEGY=C,t.MAT_DIALOG_SCROLL_STRATEGY_FACTORY=function w(t){return function(){return t.scrollStrategies.block()}},t.MAT_DIALOG_SCROLL_STRATEGY_PROVIDER=O,t.MAT_DIALOG_SCROLL_STRATEGY_PROVIDER_FACTORY=D,t.MatDialog=A,t.MatDialogActions=E,t.MatDialogClose=k,t.MatDialogConfig=h,t.MatDialogContainer=m,t.MatDialogContent=x,t.MatDialogModule=S,t.MatDialogRef=y,t.MatDialogTitle=T,t.matDialogAnimations=g,t.throwMatDialogContentAlreadyAttachedError=f,Object.defineProperty(t,"__esModule",{value:!0})}));