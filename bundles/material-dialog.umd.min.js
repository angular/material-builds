...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */(e,this._defaultOptions||new _)).id&&this.getDialogById(e.id);var a=this._createOverlay(e),i=this._attachDialogContainer(a,e),r=this._attachDialogContent(t,i,a,e);return this.openDialogs.length||this._hideNonDialogContentFromAssistiveTechnology(),this.openDialogs.push(r),r.afterClosed().subscribe((function(){return o._removeOpenDialog(r)})),this.afterOpened.next(r),i._initializeWithAttachedContent(),r},t.prototype.closeAll=function(){this._closeDialogs(this.openDialogs)},t.prototype.getDialogById=function(t){return this.openDialogs.find((function(e){return e.id===t}))},t.prototype.ngOnDestroy=function(){this._closeDialogs(this._openDialogsAtThisLevel),this._afterAllClosedAtThisLevel.complete(),this._afterOpenedAtThisLevel.complete()},t.prototype._createOverlay=function(t){var e=this._getOverlayConfig(t);return this._overlay.create(e)},t.prototype._getOverlayConfig=function(t){var o=new e.OverlayConfig({positionStrategy:this._overlay.position().global(),scrollStrategy:t.scrollStrategy||this._scrollStrategy(),panelClass:t.panelClass,hasBackdrop:t.hasBackdrop,direction:t.direction,minWidth:t.minWidth,minHeight:t.minHeight,maxWidth:t.maxWidth,maxHeight:t.maxHeight,disposeOnNavigation:t.closeOnNavigation});return t.backdropClass&&(o.backdropClass=t.backdropClass),o},t.prototype._attachDialogContainer=function(t,e){var a=n.Injector.create({parent:e&&e.viewContainerRef&&e.viewContainerRef.injector||this._injector,providers:[{provide:_,useValue:e}]}),i=new o.ComponentPortal(this._dialogContainerType,e.viewContainerRef,a,e.componentFactoryResolver);return t.attach(i).instance},t.prototype._attachDialogContent=function(t,e,a,i){var r=new this._dialogRefConstructor(a,e,i.id);if(t instanceof n.TemplateRef)e.attachTemplatePortal(new o.TemplatePortal(t,null,{$implicit:i.data,dialogRef:r}));else{var s=this._createInjector(i,r,e),l=e.attachComponentPortal(new o.ComponentPortal(t,i.viewContainerRef,s));r.componentInstance=l.instance}return r.updateSize(i.width,i.height).updatePosition(i.position),r},t.prototype._createInjector=function(t,e,o){var a=t&&t.viewContainerRef&&t.viewContainerRef.injector,r=[{provide:this._dialogContainerType,useValue:o},{provide:this._dialogDataToken,useValue:t.data},{provide:this._dialogRefConstructor,useValue:e}];return!t.direction||a&&a.get(i.Directionality,null)||r.push({provide:i.Directionality,useValue:{value:t.direction,change:s.of()}}),n.Injector.create({parent:a||this._injector,providers:r})},t.prototype._removeOpenDialog=function(t){var e=this.openDialogs.indexOf(t);e>-1&&(this.openDialogs.splice(e,1),this.openDialogs.length||(this._ariaHiddenElements.forEach((function(t,e){t?e.setAttribute("aria-hidden",t):e.removeAttribute("aria-hidden")})),this._ariaHiddenElements.clear(),this._getAfterAllClosed().next()))},t.prototype._hideNonDialogContentFromAssistiveTechnology=function(){var t=this._overlayContainer.getContainerElement();if(t.parentElement)for(var e=t.parentElement.children,o=e.length-1;o>-1;o--){var n=e[o];n===t||"SCRIPT"===n.nodeName||"STYLE"===n.nodeName||n.hasAttribute("aria-live")||(this._ariaHiddenElements.set(n,n.getAttribute("aria-hidden")),n.setAttribute("aria-hidden","true"))}},t.prototype._closeDialogs=function(t){for(var e=t.length;e--;)t[e].close()},t}();x.decorators=[{type:n.Directive}],x.ctorParameters=function(){return[{type:e.Overlay},{type:n.Injector},{type:void 0},{type:void 0},{type:e.OverlayContainer},{type:void 0},{type:n.Type},{type:n.Type},{type:n.InjectionToken}]};var E=function(t){function e(e,o,n,a,i,r,s){return t.call(this,e,o,a,r,s,i,b,v,O)||this}return h(e,t),e}(x);E.decorators=[{type:n.Injectable}],E.ctorParameters=function(){return[{type:e.Overlay},{type:n.Injector},{type:r.Location,decorators:[{type:n.Optional}]},{type:_,decorators:[{type:n.Optional},{type:n.Inject,args:[T]}]},{type:void 0,decorators:[{type:n.Inject,args:[A]}]},{type:E,decorators:[{type:n.Optional},{type:n.SkipSelf}]},{type:e.OverlayContainer}]};var I=0,S=function(){function t(t,e,o){this.dialogRef=t,this._elementRef=e,this._dialog=o,this.type="button"}return t.prototype.ngOnInit=function(){this.dialogRef||(this.dialogRef=F(this._elementRef,this._dialog.openDialogs))},t.prototype.ngOnChanges=function(t){var e=t._matDialogClose||t._matDialogCloseResult;e&&(this.dialogResult=e.currentValue)},t.prototype._onButtonClick=function(t){D(this.dialogRef,0===t.screenX&&0===t.screenY?"keyboard":"mouse",this.dialogResult)},t}();S.decorators=[{type:n.Directive,args:[{selector:"[mat-dialog-close], [matDialogClose]",exportAs:"matDialogClose",host:{"(click)":"_onButtonClick($event)","[attr.aria-label]":"ariaLabel || null","[attr.type]":"type"}}]}],S.ctorParameters=function(){return[{type:b,decorators:[{type:n.Optional}]},{type:n.ElementRef},{type:E}]},S.propDecorators={ariaLabel:[{type:n.Input,args:["aria-label"]}],type:[{type:n.Input}],dialogResult:[{type:n.Input,args:["mat-dialog-close"]}],_matDialogClose:[{type:n.Input,args:["matDialogClose"]}]};var w,P,j,L=function(){function t(t,e,o){this._dialogRef=t,this._elementRef=e,this._dialog=o,this.id="mat-dialog-title-"+I++}return t.prototype.ngOnInit=function(){var t=this;this._dialogRef||(this._dialogRef=F(this._elementRef,this._dialog.openDialogs)),this._dialogRef&&Promise.resolve().then((function(){var e=t._dialogRef._containerInstance;e&&!e._ariaLabelledBy&&(e._ariaLabelledBy=t.id)}))},t}();function F(t,e){for(var o=t.nativeElement.parentElement;o&&!o.classList.contains("mat-dialog-container");)o=o.parentElement;return o?e.find((function(t){return t.id===o.id})):null}
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */L.decorators=[{type:n.Directive,args:[{selector:"[mat-dialog-title], [matDialogTitle]",exportAs:"matDialogTitle",host:{class:"mat-dialog-title","[id]":"id"}}]}],L.ctorParameters=function(){return[{type:b,decorators:[{type:n.Optional}]},{type:n.ElementRef},{type:E}]},L.propDecorators={id:[{type:n.Input}]},(w=function w(){}).decorators=[{type:n.Directive,args:[{selector:"[mat-dialog-content], mat-dialog-content, [matDialogContent]",host:{class:"mat-dialog-content"}}]}],(P=function P(){}).decorators=[{type:n.Directive,args:[{selector:"[mat-dialog-actions], mat-dialog-actions, [matDialogActions]",host:{class:"mat-dialog-actions"}}]}],(j=function j(){}).decorators=[{type:n.NgModule,args:[{imports:[e.OverlayModule,o.PortalModule,a.MatCommonModule],exports:[v,S,L,w,P,a.MatCommonModule],declarations:[v,S,L,P,w],providers:[E,k],entryComponents:[v]}]}],
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
