...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
e.EXPANSION_PANEL_ANIMATION_TIMING="225ms cubic-bezier(0.4,0.0,0.2,1)",e.MAT_ACCORDION=b,e.MAT_EXPANSION_PANEL_DEFAULT_OPTIONS=E,e.MatAccordion=T,e.MatExpansionModule=O,e.MatExpansionPanel=P,e.MatExpansionPanelActionRow=v,e.MatExpansionPanelContent=x,e.MatExpansionPanelDescription=C,e.MatExpansionPanelHeader=k,e.MatExpansionPanelTitle=M,e.matExpansionAnimations=_,e.ɵ0=void 0,Object.defineProperty(e,"__esModule",{value:!0})}));