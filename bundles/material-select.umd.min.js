...
/**
     ...
     */
var b={transformPanelWrap:y.trigger("transformPanelWrap",[y.transition("* => void",y.query("@transformPanel",[y.animateChild()],{optional:!0}))]),transformPanel:y.trigger("transformPanel",[y.state("void",y.style({transform:"scaleY(0.8)",minWidth:"100%",opacity:0})),y.state("showing",y.style({opacity:1,minWidth:"calc(100% + 32px)",transform:"scaleY(1)"})),y.state("showing-multiple",y.style({opacity:1,minWidth:"calc(100% + 64px)",transform:"scaleY(1)"})),y.transition("void => *",y.animate("120ms cubic-bezier(0, 0, 0.2, 1)")),y.transition("* => void",y.animate("100ms 25ms linear",y.style({opacity:0})))])},O=0,C=new i.InjectionToken("mat-select-scroll-strategy");
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
e.MAT_SELECT_CONFIG=M,e.MAT_SELECT_SCROLL_STRATEGY=C,e.MAT_SELECT_SCROLL_STRATEGY_PROVIDER=I,e.MAT_SELECT_SCROLL_STRATEGY_PROVIDER_FACTORY=w,e.MAT_SELECT_TRIGGER=A,e.MatSelect=E,e.MatSelectChange=S,e.MatSelectModule=T,e.MatSelectTrigger=k,e._MatSelectBase=D,e.matSelectAnimations=b,Object.defineProperty(e,"__esModule",{value:!0})}));