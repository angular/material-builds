...
/**
     ...
     */
var b={transformPanelWrap:m.trigger("transformPanelWrap",[m.transition("* => void",m.query("@transformPanel",[m.animateChild()],{optional:!0}))]),transformPanel:m.trigger("transformPanel",[m.state("void",m.style({transform:"scaleY(0.8)",minWidth:"100%",opacity:0})),m.state("showing",m.style({opacity:1,minWidth:"calc(100% + 32px)",transform:"scaleY(1)"})),m.state("showing-multiple",m.style({opacity:1,minWidth:"calc(100% + 64px)",transform:"scaleY(1)"})),m.transition("void => *",m.animate("120ms cubic-bezier(0, 0, 0.2, 1)")),m.transition("* => void",m.animate("100ms 25ms linear",m.style({opacity:0})))])},O=0,C=new i.InjectionToken("mat-select-scroll-strategy");
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
e.MAT_SELECT_CONFIG=M,e.MAT_SELECT_SCROLL_STRATEGY=C,e.MAT_SELECT_SCROLL_STRATEGY_PROVIDER=I,e.MAT_SELECT_SCROLL_STRATEGY_PROVIDER_FACTORY=w,e.MAT_SELECT_TRIGGER=T,e.MatSelect=R,e.MatSelectChange=S,e.MatSelectModule=D,e.MatSelectTrigger=k,e.SELECT_ITEM_HEIGHT_EM=3,e.SELECT_MULTIPLE_PANEL_PADDING_X=40,e.SELECT_PANEL_INDENT_PADDING_X=32,e.SELECT_PANEL_MAX_HEIGHT=256,e.SELECT_PANEL_PADDING_X=16,e.SELECT_PANEL_VIEWPORT_PADDING=8,e._MatSelectBase=A,e.matSelectAnimations=b,Object.defineProperty(e,"__esModule",{value:!0})}));