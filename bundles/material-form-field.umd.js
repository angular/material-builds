(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var MatFormFieldControl = /** @class */ (function () {
        ...
        MatFormFieldControl = __decorate([
            core.Directive()
        ], MatFormFieldControl);
    ...
    var MatFormField = /** @class */ (function (_super) {
        ...
        __decorate([
            core.ContentChild(MatPlaceholder),
        ...
        MatFormField = MatFormField_1 = __decorate([
            ...
            __param(2, core.Optional()), __param(2, core.Inject(core$1.MAT_LABEL_GLOBAL_OPTIONS)),
            __param(3, core.Optional()),
            __param(4, core.Optional()), __param(4, core.Inject(MAT_FORM_FIELD_DEFAULT_OPTIONS)),
            __param(7, core.Optional()), __param(7, core.Inject(animations$1.ANIMATION_MODULE_TYPE)),
            __metadata("design:paramtypes", [core.ElementRef, core.ChangeDetectorRef, Object, bidi.Directionality, Object, platform.Platform, core.NgZone, String])
        ], MatFormField);
        return MatFormField;
