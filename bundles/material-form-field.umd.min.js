...
/**
     ...
     */var p=0,u=function(){function e(){this.id="mat-error-"+p++}return e.decorators=[{type:a.Directive,args:[{selector:"mat-error",host:{class:"mat-error",role:"alert","[attr.id]":"id"}}]}],e.propDecorators={id:[{type:a.Input}]},e}(),h={transitionMessages:d.trigger("transitionMessages",[d.state("enter",d.style({opacity:1,transform:"translateY(0%)"})),d.transition("void => enter",[d.style({opacity:0,transform:"translateY(-100%)"}),d.animate("300ms cubic-bezier(0.55, 0, 0.55, 0.2)")])])},b=function b(){};
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
