...
/**
     ...
     */var p=0,u=function(){function e(){this.id="mat-error-"+p++}return e.decorators=[{type:a.Directive,args:[{selector:"mat-error",host:{class:"mat-error",role:"alert","[attr.id]":"id"}}]}],e.propDecorators={id:[{type:a.Input}]},e}(),h={transitionMessages:s.trigger("transitionMessages",[s.state("enter",s.style({opacity:1,transform:"translateY(0%)"})),s.transition("void => enter",[s.style({opacity:0,transform:"translateY(-100%)"}),s.animate("300ms cubic-bezier(0.55, 0, 0.55, 0.2)")])])},b=function b(){};
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
e.MatFormFieldModule=S,e.MatError=u,e.MAT_FORM_FIELD_DEFAULT_OPTIONS=M,e.MatFormField=I,e.MatFormFieldControl=b,e.getMatFormFieldPlaceholderConflictError=g,e.getMatFormFieldDuplicatedHintError=_,e.getMatFormFieldMissingControlError=y,e.MatHint=x,e.MatPlaceholder=C,e.MatPrefix=k,e.MatSuffix=F,e.MatLabel=w,e.matFormFieldAnimations=h,Object.defineProperty(e,"__esModule",{value:!0})});