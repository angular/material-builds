...
/**
     ...
     */
var b,_=[g,f,h,m,v,p,y];(b=function b(){}).decorators=[{type:r.NgModule,args:[{imports:[t.CdkTreeModule,n.MatCommonModule],exports:[n.MatCommonModule,_],declarations:_}]}];var T=function(){function e(e,t,r,n){this.transformFunction=e,this.getLevel=t,this.isExpandable=r,this.getChildren=n}return e.prototype._flattenNode=function(e,t,r,n){var o=this,a=this.transformFunction(e,t);if(r.push(a),this.isExpandable(a)){var i=this.getChildren(e);i&&(Array.isArray(i)?this._flattenChildren(i,t,r,n):i.pipe(s.take(1)).subscribe((function(e){o._flattenChildren(e,t,r,n)})))}return r},e.prototype._flattenChildren=function(e,t,r,n){var o=this;e.forEach((function(a,i){var s=n.slice();s.push(i!=e.length-1),o._flattenNode(a,t+1,r,s)}))},e.prototype.flattenNodes=function(e){var t=this,r=[];return e.forEach((function(e){return t._flattenNode(e,0,r,[])})),r},e.prototype.expandFlattenedNodes=function(e,t){var r=this,n=[],o=[];return o[0]=!0,e.forEach((function(e){for(var a=!0,i=0;i<=r.getLevel(e);i++)a=a&&o[i];a&&n.push(e),r.isExpandable(e)&&(o[r.getLevel(e)+1]=t.isExpanded(e))})),n},e}(),x=function(e){function t(t,r,n){var o=e.call(this)||this;return o._treeControl=t,o._treeFlattener=r,o._flattenedData=new i.BehaviorSubject([]),o._expandedData=new i.BehaviorSubject([]),o._data=new i.BehaviorSubject([]),n&&(o.data=n),o}return c(t,e),Object.defineProperty(t.prototype,"data",{get:function(){return this._data.value},set:function(e){this._data.next(e),this._flattenedData.next(this._treeFlattener.flattenNodes(this.data)),this._treeControl.dataNodes=this._flattenedData.value},enumerable:!1,configurable:!0}),t.prototype.connect=function(e){var t=this;return i.merge(e.viewChange,this._treeControl.expansionModel.changed,this._flattenedData).pipe(s.map((function(){return t._expandedData.next(t._treeFlattener.expandFlattenedNodes(t._flattenedData.value,t._treeControl)),t._expandedData.value})))},t.prototype.disconnect=function(){},t}(a.DataSource),N=function(e){function t(){var t=e.apply(this,l([],u(arguments)))||this;return t._data=new i.BehaviorSubject([]),t}return c(t,e),Object.defineProperty(t.prototype,"data",{get:function(){return this._data.value},set:function(e){this._data.next(e)},enumerable:!1,configurable:!0}),t.prototype.connect=function(e){var t=this;return i.merge.apply(void 0,[e.viewChange,this._data]).pipe(s.map((function(){return t.data})))},t.prototype.disconnect=function(){},t}(a.DataSource);
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
