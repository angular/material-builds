...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
e.MAT_MENU_CONTENT=k,e.MAT_MENU_DEFAULT_OPTIONS=w,e.MAT_MENU_PANEL=C,e.MAT_MENU_SCROLL_STRATEGY=D,e.MatMenu=S,e.MatMenuContent=I,e.MatMenuItem=O,e.MatMenuModule=j,e.MatMenuTrigger=N,e._MatMenuBase=E,e._MatMenuDirectivesModule=A,e.fadeInItems=v,e.matMenuAnimations=b,e.transformMenu=M,e.ɵangular_material_src_material_menu_menu_a=x,e.ɵangular_material_src_material_menu_menu_b=T,e.ɵangular_material_src_material_menu_menu_c=F,Object.defineProperty(e,"__esModule",{value:!0})}));