...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
e.ɵangular_material_src_material_menu_menu_a=O,e.ɵangular_material_src_material_menu_menu_b=w,e.ɵangular_material_src_material_menu_menu_c=R,e.MatMenu=x,e.MAT_MENU_DEFAULT_OPTIONS=k,e._MatMenu=P,e._MatMenuBase=C,e.MatMenuItem=v,e.MatMenuTrigger=D,e.MAT_MENU_SCROLL_STRATEGY=E,e.MAT_MENU_PANEL=b,e._MatMenuDirectivesModule=T,e.MatMenuModule=A,e.matMenuAnimations=_,e.fadeInItems=g,e.transformMenu=f,e.MatMenuContent=y,Object.defineProperty(e,"__esModule",{value:!0})});