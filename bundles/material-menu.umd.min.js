...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
e.MAT_MENU_CONTENT=k,e.MAT_MENU_DEFAULT_OPTIONS=P,e.MAT_MENU_PANEL=C,e.MAT_MENU_SCROLL_STRATEGY=T,e.MatMenu=E,e.MatMenuContent=I,e.MatMenuItem=O,e.MatMenuModule=j,e.MatMenuTrigger=N,e._MatMenuBase=S,e._MatMenuDirectivesModule=A,e.fadeInItems=v,e.matMenuAnimations=b,e.transformMenu=M,e.ɵangular_material_src_material_menu_menu_a=x,e.ɵangular_material_src_material_menu_menu_b=D,e.ɵangular_material_src_material_menu_menu_c=F,Object.defineProperty(e,"__esModule",{value:!0})}));