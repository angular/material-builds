...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
e.MAT_MENU_DEFAULT_OPTIONS=k,e.MAT_MENU_PANEL=b,e.MAT_MENU_SCROLL_STRATEGY=E,e.MatMenu=x,e.MatMenuContent=y,e.MatMenuItem=v,e.MatMenuModule=A,e.MatMenuTrigger=D,e._MatMenu=P,e._MatMenuBase=C,e._MatMenuDirectivesModule=T,e.fadeInItems=_,e.matMenuAnimations=g,e.transformMenu=f,e.ɵangular_material_src_material_menu_menu_a=O,e.ɵangular_material_src_material_menu_menu_b=w,e.ɵangular_material_src_material_menu_menu_c=R,Object.defineProperty(e,"__esModule",{value:!0})}));