...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
e.MatTableModule=k,e.MatCellDef=d,e.MatHeaderCellDef=u,e.MatFooterCellDef=p,e.MatColumnDef=f,e.MatHeaderCell=m,e.MatFooterCell=h,e.MatCell=g,e.MatTable=c,e.MatHeaderRowDef=y,e.MatFooterRowDef=C,e.MatRowDef=D,e.MatHeaderRow=_,e.MatFooterRow=x,e.MatRow=b,e.MatTableDataSource=E,e.MatTextColumn=w,Object.defineProperty(e,"__esModule",{value:!0})});