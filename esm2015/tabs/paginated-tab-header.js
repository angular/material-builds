...
export class MatPaginatedTabHeader {
    ...
    _updateTabScrollPosition() {
        ...
        // @breaking-change 9.0.0-sha-fdae14ad5 Remove null check for `platform` after it can no longer be undefined.
...
if (false) {
    ...
    /**
     * @deprecated \@breaking-change 9.0.0-sha-fdae14ad5 `_platform` and `_animationMode`
