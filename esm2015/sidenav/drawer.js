    ...
    class MatDrawerContainer {
        ...
        ngAfterContentInit() {
            this._allDrawers.changes
                ...
                .subscribe((drawer) => {
                // @breaking-change 10.0.0-sha-952f57631 Remove `_container` check once container parameter is required.
