...
export { ɵa17, MatGridListModule, MatGridList, MatGridTile, MatGridTileText, MatGridAvatarCssMatStyler, MatGridTileHeaderCssMatStyler, MatGridTileFooterCssMatStyler } from '@angular/material/grid-list';
 ...
 * Current version of Angular Material.
  @type {?} */
const VERSION = new Version('7.0.0-rc.1-a90aaea');
