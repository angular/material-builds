...
MdListItem.decorators = [
    { type: Component, args: [{selector: 'md-list-item, mat-list-item, a[md-list-item], a[mat-list-item]',
                ...
                template: "<div class=\"mat-list-item-content\" [class.mat-list-item-focus]=\"_hasFocus\"> <div class=\"mat-list-item-ripple\" md-ripple [mdRippleDisabled]=\"!isRippleEnabled()\"></div> <ng-content select=\"[md-list-avatar],[md-list-icon], [mat-list-avatar], [mat-list-icon]\"></ng-content> <div class=\"mat-list-text\"><ng-content select=\"[md-line], [mat-line]\"></ng-content></div> <ng-content></ng-content> </div> ",
                encapsulation: ViewEncapsulation.None
            },] },
];
/**
...
class MdDatepicker {
     ...
     * @param {?} _dir
     */
    constructor(_dialog, _overlay, _viewContainerRef, _dateAdapter, _dir) {
    ...
    _createPopupPositionStrategy() {
        let /** @type {?} */ origin = ({ originX: 'start', originY: 'bottom' });
        let /** @type {?} */ overlay = ({ overlayX: 'start', overlayY: 'top' });
