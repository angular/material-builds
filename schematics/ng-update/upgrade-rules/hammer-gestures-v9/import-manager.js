...
(function (factory) {
    ...
    (function (ImportState) {
        ImportState[ImportState["UNMODIFIED"] = 0] = "UNMODIFIED";
        ImportState[ImportState["MODIFIED"] = 2] = "MODIFIED";
        ImportState[ImportState["ADDED"] = 4] = "ADDED";
        ImportState[ImportState["DELETED"] = 8] = "DELETED";
    ...
    class ImportManager {
        ...
        _analyzeImportsIfNeeded(sourceFile) {
            ...
            for (let node of sourceFile.statements) {
                ...
                if (!node.importClause.namedBindings) {
                    result.push({ moduleName, node, name: node.importClause.name, state: ImportState.UNMODIFIED });
                    continue;
                }
        ...
        recordChanges() {
            this._importCache.forEach((fileImports, sourceFile) => {
                ...
                const lastUnmodifiedImport = fileImports.reverse().find(i => i.state === ImportState.UNMODIFIED);
