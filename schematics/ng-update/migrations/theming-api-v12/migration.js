...
function migrateMaterialSymbols(content, importPath, detectedImports, commentPlaceholders, extraMaterialSymbols = {}) {
    ...
    const functionsToUpdate = { ...config_1.materialFunctions, ...extraMaterialSymbols.functions };
    ...
    const variablesToUpdate = { ...config_1.materialVariables, ...extraMaterialSymbols.variables };
