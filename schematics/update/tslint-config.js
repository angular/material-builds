...
const upgradeRules = [
    ...
    'check-template-misc',
    // Ripple misc V7
    ['ripple-speed-factor-assignment', target_version_1.TargetVersion.V7],
    ['ripple-speed-factor-template', target_version_1.TargetVersion.V7],
];
 ...
 */
function createTslintConfig(target, extraStyleFiles) {
