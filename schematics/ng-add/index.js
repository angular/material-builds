 ...
 */
const fallbackMaterialVersionRange = `~22.0.0-next.3+sha-e01062a-with-local-changes`;
/**
...
function default_1(options) {
    return (host, context) => {
        ...
        const angularDependencyVersion = ngCoreVersionTag || `^22.0.0-0 || ^22.1.0-0 || ^22.2.0-0 || ^22.3.0-0 || ^23.0.0-0`;
