...
import { j as MatFormField } from './form-field-vb46puZb.mjs';
import { g as MatSelect, M as MatSelectModule } from './module-C_BgJCn5.mjs';
import { e as MatTooltip, h as MatTooltipModule } from './module-DaxX9xJU.mjs';
import { M as MatOption } from './option-DwhsOWVD.mjs';
...
import './error-options-4qnuf3R5.mjs';
import './error-state-Dtb1IHM-.mjs';
import './index-GV4vU4E9.mjs';
import './index-fFmsNo6M.mjs';
import './common-module-CyAXkxDt.mjs';
import './ripple-4QeIW0PY.mjs';
import '@angular/cdk/private';
import './pseudo-checkbox-module-DSmxMEl_.mjs';
import './pseudo-checkbox-qz79KL6W.mjs';
import './module-6D8NxYUo.mjs';
...
class MatPaginatorIntl {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.1.0", ngImport: i0, type: MatPaginatorIntl, deps: [], target: i0.ɵɵFactoryTarget.Injectable });
    static ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "20.1.0", ngImport: i0, type: MatPaginatorIntl, providedIn: 'root' });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.1.0", ngImport: i0, type: MatPaginatorIntl, decorators: [{
            type: Injectable,
...
class MatPaginatorModule {
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.1.0", ngImport: i0, type: MatPaginatorModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
    static ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "20.1.0", ngImport: i0, type: MatPaginatorModule, imports: [MatButtonModule, MatSelectModule, MatTooltipModule, MatPaginator], exports: [MatPaginator] });
    static ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "20.1.0", ngImport: i0, type: MatPaginatorModule, providers: [MAT_PAGINATOR_INTL_PROVIDER], imports: [MatButtonModule, MatSelectModule, MatTooltipModule, MatPaginator] });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.1.0", ngImport: i0, type: MatPaginatorModule, decorators: [{
            type: NgModule,
            args: [{
