...
class MatCheckbox extends _MatCheckboxMixinBase {
    ...
    constructor(elementRef, _changeDetectorRef, _ngZone, tabIndex, _animationMode, _options) {
        super(elementRef);
