...
import { InjectionToken, inject, ElementRef, DOCUMENT, ChangeDetectorRef, booleanAttribute, Input, ViewEncapsulation, Component, TemplateRef, ApplicationRef, Injector, ViewContainerRef, Directive, QueryList, signal, EventEmitter, afterNextRender, Output, ContentChild, ContentChildren, ViewChild, NgZone, Renderer2, NgModule } from '@angular/core';
...
class MatMenuItem {
  ...
  getLabel() {
    ...
    const icons = clone.querySelectorAll('mat-icon, .material-icons, .material-symbols-outlined, ' + '.material-symbols-rounded, .material-symbols-sharp');
