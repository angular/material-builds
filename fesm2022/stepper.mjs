...
import { Directive, Service, inject, ChangeDetectorRef, Input, ViewEncapsulation, Component, TemplateRef, ViewContainerRef, NgZone, Renderer2, signal, QueryList, EventEmitter, input, ElementRef, ContentChild, Output, ContentChildren, ViewChildren, NgModule } from '@angular/core';
