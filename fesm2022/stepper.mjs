...
class MatStep extends CdkStep {
    ...
    static { this.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "17.0.0", type: MatStep, isStandalone: true, selector: "mat-step", inputs: { color: "color" }, providers: [
