...
import { Directive, Optional, SkipSelf, Injectable, inject, ChangeDetectorRef, Input, ChangeDetectionStrategy, ViewEncapsulation, Component, TemplateRef, ViewContainerRef, NgZone, Renderer2, ANIMATION_MODULE_TYPE, signal, QueryList, EventEmitter, ElementRef, ContentChild, Output, ContentChildren, ViewChildren, NgModule } from '@angular/core';
...
import './icon-registry-BRgH4K8p.mjs';
