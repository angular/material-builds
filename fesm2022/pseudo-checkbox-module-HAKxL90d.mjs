...
class MatPseudoCheckboxModule {
    ...
    static ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "20.2.0-next.2", ngImport: i0, type: MatPseudoCheckboxModule, imports: [MatPseudoCheckbox], exports: [MatPseudoCheckbox, BidiModule] });
    static ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "20.2.0-next.2", ngImport: i0, type: MatPseudoCheckboxModule, imports: [BidiModule] });
}
...
//# sourceMappingURL=pseudo-checkbox-module-HAKxL90d.mjs.map
