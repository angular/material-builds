...
import { InjectionToken, inject, ElementRef, numberAttribute, booleanAttribute, Input, Directive, ChangeDetectorRef, NgZone, EventEmitter, Injector, ANIMATION_MODULE_TYPE, ViewChild, ContentChild, Output, ContentChildren, ChangeDetectionStrategy, ViewEncapsulation, Component, afterNextRender, QueryList, forwardRef, NgModule } from '@angular/core';
import { Subject, merge } from 'rxjs';
import { _StructuralStylesLoader } from './structural-styles-B2ekkpE5.mjs';
import { MAT_RIPPLE_GLOBAL_OPTIONS } from './ripple-BPguEKwi.mjs';
...
import { MatFormFieldControl, MAT_FORM_FIELD } from './form-field-BPX7ZLIc.mjs';
