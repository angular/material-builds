...
import { MatOption, MAT_OPTION_PARENT_COMPONENT } from './option-CzXGMJhG.mjs';
import { Validators, NG_VALUE_ACCESSOR, NG_VALIDATORS } from '@angular/forms';
import { MAT_FORM_FIELD } from './form-field-BAyQDs0C.mjs';
import { MAT_INPUT_VALUE_ACCESSOR } from './input-value-accessor-cp3A3zMa.mjs';
import { MatIconButton } from './icon-button-BztjwnpO.mjs';
...
import './ripple-loader-DGBeEMcN.mjs';
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.6", ngImport: i0, type: MatTimepicker, decorators: [{
            type: Component,
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.6", ngImport: i0, type: MatTimepickerInput, decorators: [{
            type: Directive,
            args: [{
