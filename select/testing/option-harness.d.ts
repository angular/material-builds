...
export declare class MatSelectOptionHarness extends ComponentHarness {
    static with(options?: OptionHarnessFilters): HarnessPredicate<MatSelectOptionHarness>;
...
export declare class MatSelectOptionGroupHarness extends ComponentHarness {
    private _label;
    static hostSelector: string;
    static with(options?: OptionGroupHarnessFilters): HarnessPredicate<MatSelectOptionGroupHarness>;
