...
var MatPaginatedTabHeader = /** @class */ (function () {
    ...
    /**
     * @deprecated @breaking-change 9.0.0-sha-d8b726d3c `_platform` and `_animationMode`
    ...
    MatPaginatedTabHeader.prototype._updateTabScrollPosition = function () {
        ...
        // @breaking-change 9.0.0-sha-d8b726d3c Remove null check for `platform` after it can no longer be undefined.
