...
import { CdkPortalOutlet, BasePortalOutlet, PortalModule, DomPortalOutlet, PortalInjector, ComponentPortal, TemplatePortal } from '@angular/cdk/portal';
...
import { __extends, __values, __assign, __read } from 'tslib';
...
var MatSnackBar = /** @class */ (function () {
    ...
    MatSnackBar.prototype._createOverlay = function (config) {
        var overlayConfig = new OverlayConfig$1();
